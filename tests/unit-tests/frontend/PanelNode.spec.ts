import {
  ...
  PanelNode,
  focusedPanelStore,
} from "../../../src/frontend/lib/PanelNode";
...
describe("Test PanelGroup", () => {
  ...
  test("Test constructor", () => {
    ...
    panelNode = new PanelGroup("Hello");
  ...
  test("Removing panels", () => {
    ...
    panelNode2.addPanelGroup(panelNode, 0);
    panelNode.removePanel(0);
    expect(panelNode2.panels.length).toBe(2);
